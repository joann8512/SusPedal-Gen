...
import miditoolkit_ped.miditoolkit 
#from miditoolkit.midi import parser as mid_parser
#from miditoolkit.pianoroll import parser as pr_parser
from miditoolkit_ped.miditoolkit.midi.containers import Marker, Instrument, TempoChange
...
def proc_one(path_infile, path_outfile):
    try:
        ...
        # load
        midi_obj = miditoolkit_ped.miditoolkit.midi.parser.MidiFile(path_infile)
...
if __name__ == '__main__':
    # paths
    path_indir = './MAESTRO_synchronized'
    path_outdir = './MAESTRO_analyzed'
